    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        iconView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent("capture-image");
                intent.putExtra("message", "capture_image");
                LocalBroadcastManager.getInstance(getApplicationContext()).sendBroadcast(intent);
            }
        });

        mFloatingViewManager = new FloatingViewManager(this, this);
        mFloatingViewManager.setFixedTrashIconImage(R.drawable.ic_action_help);
        mFloatingViewManager.setActionTrashIconImage(R.drawable.ic_action_help);
